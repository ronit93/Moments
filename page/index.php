  ...
  <body>
			      	...
			      	<li class="item" draggable="true" data-index="<?php echo $i; ?>">
		                ...
		                <!--<div class="options">
		                  ...
		                  <a href="/moments/php/deleteItem.php?ch_id=<?php echo $chapterID; ?>&pg_id=<?php echo $pageID; ?>&it_id=<?php echo $i; ?>"><img id="trash" src="/moments/img/trash.png"></a>
		                		...
		                		<img class="content" src="<?php echo $_SESSION['chapters'][$chapterID]['pages'][$pageID]['items'][$i]['thumb']; ?>">
	...
	<?php endif; ?>
      ...
      <div class="form hidden" id="uploadAdd">
        <h3>Upload Item</h3>
        <form action="/moments/php/addItem.php?ch_id=<?php echo $chapterID; ?>&pg_id=<?php echo $pageID; ?>" method="post" enctype="multipart/form-data" id="uploadAddForm">
          <div class="input">
           <fieldset>
              <div class="import">
	              <input type="hidden" name="upload" value="true">
	              <p>Upload your Item:</p>
                  <input class="field" type="file" name="mediaUpload" id="uploadMediaInput">
          ...
          <div class="input">
           <fieldset>
              <div class="import">
                ...
                <div class="icons">
                  <div class="facebook pointer"><img src="../img/facebook.png"></div>
                  <div class="instagram pointer"><img src="../img/instagram.png"></div>
                  <div class="twitter pointer"><img src="../img/twitter1.png"></div>
                  <div class="folder pointer"><img src="../img/Grey_Generic_Folder.png"></div>
                </div>
              </div>
            </fieldset>
          </div>
